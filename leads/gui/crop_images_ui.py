...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.CorrectChromaticShiftCheckBox = QtWidgets.QCheckBox(Form)
        self.CorrectChromaticShiftCheckBox.setObjectName("CorrectChromaticShiftCheckBox")
        self.gridLayout_2.addWidget(self.CorrectChromaticShiftCheckBox, 0, 0, 1, 2)
        ...
        self.loadImageBtn.setShortcut("Ctrl+L")
        ...
        self.loadImageJroisBtn.setShortcut("Ctrl+R")
        ...
        self.cropSelectedBtn.setShortcut("Ctrl+X")
        ...
        self.saveImageJroisBtn.setShortcut("Ctrl+T")
        ...
        self.bkgSubtractionCheckBox = QtWidgets.QCheckBox(Form)
        self.bkgSubtractionCheckBox.setObjectName("bkgSubtractionCheckBox")
        self.gridLayout_5.addWidget(self.bkgSubtractionCheckBox, 0, 1, 1, 1)
        self.meanSubtractionCheckBox = QtWidgets.QCheckBox(Form)
        self.meanSubtractionCheckBox.setObjectName("meanSubtractionCheckBox")
        self.gridLayout_5.addWidget(self.meanSubtractionCheckBox, 0, 2, 1, 1)
        ...
        self.DragImageLayerCheckBox = QtWidgets.QCheckBox(Form)
        self.DragImageLayerCheckBox.setObjectName("DragImageLayerCheckBox")
        self.horizontalLayout_3.addWidget(self.DragImageLayerCheckBox)
    ...
    def retranslateUi(self, Form):
        ...
        self.CorrectChromaticShiftCheckBox.setText(_translate("Form", "Correct chromatic shift"))
        self.label_3.setText(_translate("Form", "angle [°]"))
        self.label_4.setText(_translate("Form", "x-shift [px]"))
        self.label_5.setText(_translate("Form", "y-shift [px]"))
        ...
        self.bkgSubtractionCheckBox.setText(_translate("Form", "Subtract bckg"))
        self.meanSubtractionCheckBox.setText(_translate("Form", "Subtract mean"))
        ...
        self.DragImageLayerCheckBox.setText(_translate("Form", "Layer draggable"))        
